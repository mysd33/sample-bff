...
@Data
@ConfigurationProperties(prefix = PaginationConfigurationProperties.PROPERTY_PREFIX)
public class PaginationConfigurationProperties {
    static final String PROPERTY_PREFIX = FrameworkConstants.PROPERTY_BASE_NAME + "pagination";
    // 参考
